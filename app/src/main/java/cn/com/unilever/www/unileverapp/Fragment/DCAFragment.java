...
public class DCAFragment extends Fragment implements View.OnClickListener, View.OnTouchListener {
    ...
    private DCAObservationFragment fragment;
        ...
        switch (v.getId()) {
                ...
                if (dataList != null) {
                    ...
                    ll_area.setOnOptionsSelectListener(new OptionsPickerView.OnOptionsSelectListener() {
                        ...
                        public void onOptionsSelect(int option1, int option2, int option3) {
                            ...
                            MyConfig.area = keylist.get(option1);
                        }
                    });
                    ll_area.show();
                } else {
            ...
            case R.id.btn_begin:
                if (tv_area.getText().toString().length() > 0 && tv_class.getText().toString().length() > 0 && et_person.getText().toString().length() > 0) {
                    if (fragment == null) {
                        fragment = new DCAObservationFragment();
                    }
